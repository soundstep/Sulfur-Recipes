...
```
Task(
  prompt="Read /Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/get-shit-done/templates/VALIDATION.md`
