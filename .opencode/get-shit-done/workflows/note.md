...
- **Global scope**: `/Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/notes/`)
...
2. Glob `/Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/notes/` — works in any directory
