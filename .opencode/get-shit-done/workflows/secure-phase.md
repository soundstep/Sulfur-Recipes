...
```
Task(
  prompt="Read /Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/RomuQuan/Documents/devserver/workspace/Sulfur-Recipes/.opencode/get-shit-done/templates/SECURITY.md`
