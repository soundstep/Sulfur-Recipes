...
- [ ] 03-02-PLAN.md — Cloudflare Worker (`artifacts/worker`) with KV adapter; deploy Worker
- [ ] 03-03-PLAN.md — Cloudflare Pages deploy + Pages Functions proxy for `/api/*`
...
| 3. Cloudflare Deploy | 1/3 | In Progress | - |
